<x-app-layout>
    ...
    <x-slot name="header" class="flex justify-end">
        <a href="{{ route('productos.create') }}" class="px-2 py-3 bg-green-400 hover:bg-green-500 text-white rounded-lg">
            Nuevo Producto
        </a>
    </x-slot>
        ...
        <table class="min-w-full bg-white">
            <thead>
                <tr>
                    ...
                    <td class="py-2 px-4 border-b border-gray-200 font-bold">Precio</td>
                    <td class="py-2 px-4 border-b border-gray-200 font-bold">Stock</td>
                    <td class="py-2 px-4 border-b border-gray-200 font-bold">Descripcion</td>
                ...
                @foreach ($products as $product)
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b border-gray-200 flex gap-4 items-center justify-end">
                            <a href="{{ route('productos.edit', $product->id) }}" class="px-2 py-3 bg-blue-400 hover:bg-blue-500 text-white rounded-lg flex items-center gap-1">
                            ...
                            {{ Aire::open()->route('productos.destroy', $product->id) }}
